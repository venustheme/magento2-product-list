# Venustheme Magento 2 Product List

## Venustheme Magento 2 Product List supports you to create a wanted list of products based on attribute, types, conditions of items.
...
- Download from our Live site: http://www.venustheme.com/theme/magento-rule-based-product-relations/
- Get Support: https://landofcoder.ticksy.com/

## 2. Highlight features:

### Multiple targeted merchandising methods
This Magento Rule-Based Product Relations extension support Multiple targeted merchandising methods such as Best Value, Latest, New Arrival, Special, Most Popular, Best Seller, Top Rate, Random

### Widget Support
They can be placed on any position of page when you create with widget instance. There are 4 types: Carousel By Rules, New Products List By Rules,Tabs By Categories, Tabs By Rules


### Easy To Use Magento Rule-Based Product Relations Extension
It is very easy for you to change Product Order, Show timer countdown, Limit Product Number, Show Out of Stock Product

### Custom design
You can choose different layouts for your list. There are 4 types of layout support: 1 column, 2 columns with right bar, 2 columns with left bar, 3 columns. Also you can make your own column by yourself.
